...
-- 최근 7일 이내 (인기 테마 집계 포함)
('김민수', '2026-05-13', 1, 1,  'RESERVED'),
('정하늘', '2026-05-13', 5, 5,  'RESERVED'),
('이서연', '2026-05-12', 2, 1,  'RESERVED'),
('최유진', '2026-05-12', 4, 4,  'RESERVED'),
('정하늘', '2026-05-12', 5, 5,  'RESERVED'),
('이서연', '2026-05-11', 3, 1,  'RESERVED'),
('최유진', '2026-05-10', 4, 4,  'CANCELED'),
('김민수', '2026-05-09', 1, 1,  'RESERVED'),
('이서연', '2026-05-08', 2, 2,  'RESERVED'),
('박지훈', '2026-05-07', 3, 3,  'RESERVED'),

-- 7일 이전 (과거) ─ 일부 CANCELED
('김민수', '2026-05-05', 1, 1,  'RESERVED'),
('이서연', '2026-05-05', 2, 2,  'RESERVED'),
('박지훈', '2026-05-05', 3, 3,  'RESERVED'),
('최유진', '2026-05-05', 4, 4,  'RESERVED'),
('정하늘', '2026-05-05', 5, 5,  'RESERVED'),
('정하늘', '2026-05-05', 10, 5, 'RESERVED'),

('한지민', '2026-05-04', 1, 6,  'RESERVED'),
('오세훈', '2026-05-04', 2, 7,  'CANCELED'),
('윤아름', '2026-05-04', 3, 8,  'RESERVED'),
('강도윤', '2026-05-04', 4, 9,  'RESERVED'),
('신예린', '2026-05-04', 5, 10, 'CANCELED'),

('임재현', '2026-05-03', 1, 11, 'RESERVED'),
('송나연', '2026-05-03', 2, 12, 'RESERVED'),
('조현우', '2026-05-03', 3, 13, 'RESERVED'),
('백수진', '2026-05-03', 4, 14, 'CANCELED'),
('문지호', '2026-05-03', 5, 15, 'RESERVED'),

('서다은', '2026-05-02', 1, 2,  'RESERVED'),
('권민재', '2026-05-01', 2, 4,  'RESERVED'),
('남지수', '2026-04-30', 3, 6,  'RESERVED'),
('홍예준', '2026-04-29', 4, 8,  'RESERVED'),
('유다인', '2026-04-29', 5, 10, 'CANCELED'),

('장태윤', '2026-04-28', 1, 3,  'RESERVED'),
('노서진', '2026-04-26', 2, 5,  'RESERVED'),
('류시우', '2026-04-24', 3, 7,  'RESERVED'),
('이서연', '2026-04-21', 4, 9,  'RESERVED'),
('안현서', '2026-04-16', 5, 11, 'RESERVED'),
('구민아', '2026-04-06', 1, 13, 'RESERVED'),
('차도현', '2026-03-22', 2, 15, 'RESERVED'),
